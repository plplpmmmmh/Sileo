...
@objc public class PackageStateBadgeView: UIView {
    ...
    func backgroundColor(state: PackageBadgeState) -> UIColor {
        switch state {
        case .installed:
            return UIColor(red: 0.588, green: 0.729, blue: 0.655, alpha: 1)
        case .installQueued, .updateQueued, .reinstallQueued:
            return UIColor(red: 0.549, green: 0.698, blue: 0.757, alpha: 1)
        case .deleteQueued:
            return UIColor(red: 0.906, green: 0.6, blue: 0.596, alpha: 1)
        }
    }
